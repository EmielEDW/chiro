            ...
            {favoriteItems.map((item) => {
              ...
              return (
                <Card 
                  ...
                  className={`smooth-transition hover-lift relative bg-gradient-to-t from-primary/10 to-white hover:from-primary/20 hover:to-white border-primary/30 ${!affordable || isOutOfStock ? 'opacity-50' : 'hover:shadow-lg'} ring-2 ring-primary/50`}
                >
                  <CardContent className="p-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            {groupedItems[category].map((item) => {
              ...
              return (
                <Card 
                  key={item.id} 
                  className={`smooth-transition hover-lift relative bg-gradient-to-t from-accent/10 to-white hover:from-accent/20 hover:to-white ${!affordable || isOutOfStock ? 'opacity-50' : 'hover:shadow-lg'} ${isFavorite ? 'ring-2 ring-primary' : ''}`}
                >
                  <CardContent className="p-4">
                    <div className="flex flex-col space-y-3">
                      {/* Image placeholder */}
